...
angular.module('<%= scriptAppName %>')
    .config(function ($stateProvider, stateFactoryProvider) { $stateProvider.state('<%= statifiedPath %>', stateFactoryProvider.$get()('<%= classedName %>', {url:'<%= pageUrl %>', templateUrl: '<%= viewTemplateUrl %>'})) })
