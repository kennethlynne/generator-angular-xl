...
Generator.prototype.askForModules = function askForModules() {
  ...
  this.prompt(prompts, function (props) {
    ...
    var angMods = ["'kennethlynne.componentFactory'", "'" + this.scriptAppName + ".components'", "'ngAnimate'", "'xeditable'", "'ajoslin.promise-tracker'", "'cgBusy'", "'chieffancypants.loadingBar'", "'ui.router'"];
...
Generator.prototype.packageFiles = function () {
    ...
    this.template('../../templates/javascript/spec/errorCtrl.js', 'test/spec/unit/pages/error/index/error.js');
    this.template('../../templates/javascript/framework/mainCtrl.js', 'app/pages/index/index/index.js');
    this.template('../../templates/javascript/spec/mainCtrl.js', 'test/spec/unit/pages/index/index/index.js');
    ...
    this.template('../../templates/javascript/spec/page-view-directory-factory.js', 'test/spec/unit/framework/page-view-directory-factory.js');
    this.template('../../templates/javascript/spec/state-factory.js', 'test/spec/unit/framework/state-factory.js');
    this.template('../../templates/javascript/framework/dasherize.js', 'app/scripts/framework/dasherize.js');
    this.template('../../templates/javascript/spec/dasherize.js', 'test/spec/unit/framework/dasherize.js');
};
