...
Generator.prototype.packageFiles = function () {
    ...
    this.template('../../templates/javascript/spec/errorCtrl.js', 'test/spec/pages/error/index/error.js');
    this.template('../../templates/javascript/framework/mainCtrl.js', 'app/pages/index/index/index.js');
    this.template('../../templates/javascript/spec/mainCtrl.js', 'test/spec/pages/index/index/index.js');
